...
namespace BLTienda
{
    public class ProductosBL
    {
       ...
       public BindingList<Producto> ListaProductos { get; set; }
        ...
        /* Creamos un metodo de tipo privado de resultado que se encargara de validar cada campo de un producto*/
        private Resultado Validar(Producto producto)
        {
           ...
           if (producto.Precio < 0)
            ...
            if (producto.TipoId == 0) //Validamos tambien que los el combobox de tipos y categorias tengan un valor
            {
    ...
    public class Producto
    {
        ...
        public Tipo Tipo { get; set; } //Entityfrimework hace la secuencia alfanumerica con la clase tipo
